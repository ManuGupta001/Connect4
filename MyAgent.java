...
public class MyAgent extends Agent
{
    ...
    public void move()
    {
        ...
        } else
        {
            ...
            {
                if(isPerfectMove(savedDoubleTrickMove))
                    i = savedDoubleTrickMove;
            } else
            if(middleRow != -1 && middleRow != 0 && isPerfectMove(middleCol))
            {
                i = middleCol;
            } else
            {
                ...
                {
                    rmove = randomMove();
                    goodRandomMove = isPerfectMove(rmove);
                    count++;
    ...
    public boolean isPerfectMove(int rmove)
    {
